...
const DATABASE_NAME = 'OpenTalib-Database';
const _DATABASE_VERSION = 10;

/**
 * OpenTalib Database Instance
 */
class OpenTalibDatabase extends Dexie {
  // Table definitions
...
export const db = new OpenTalibDatabase();
